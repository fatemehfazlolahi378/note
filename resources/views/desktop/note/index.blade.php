...
@section('content')
    <div class="notes-index p-4 lg:p-8">
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <div id="dropdown{{$index}}" class="z-10 hidden absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                                        <li>
                                            <a href="{{route('desktop.notes.edit', $note)}}" class="flex items-center justify-start gap-1 px-4 py-2 hover:bg-gray-100 text-lime-700"><span class="fa fa-edit ml-1"></span>ویرایش</a>
                                        </li>
                                        <li>
        ...
        {{$notes->links('desktop.include.pagination')}}
    </div>
@endsection
