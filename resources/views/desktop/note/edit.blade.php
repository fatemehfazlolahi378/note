            ...
            <form action="{{route('desktop.notes.update',$note)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="title" value="{{$note->title}}" class="w-full rounded-lg border border-[#e8e8f7] px-[12px] lg:px-[16px] py-[8px] lg:py-[10px] focus:ring-0 focus:border-[#e8e8f7] text-sm mt-2" type="text" placeholder="یادداشت">
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="content" id="content-note">{{$note->content}}</textarea>
                </div>
                <div class="flex justify-center sm:justify-end items-center gap-2 mt-6">
                    ...
                    <a href="{{route('desktop.notes.index')}}" class="lg:w-[110px] sm:w-[100px] w-[90px] lg:h-[40px] h-[35px] lg:leading-[40px] leading-[35px] border border-rose-700 text-red-700 lg:text-sm text-[12px] rounded-[8px] text-center">انصراف</a>
                </div>
            </form>
        </div>
    </div>
