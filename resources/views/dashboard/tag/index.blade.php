...
@section('content')
    <div class="tag-index p-4 lg:p-8">
        <div class="flex justify-between lg:py-4">
            ...
            <a href="{{route('dashboard.tags.create')}}" class="flex items-center justify-center lg:w-[150px] w-[130px] xl:h-[45px] h-[40px] xl:leading-[45px] leading-[40px] bg-[#326273] text-white text-[12px] lg:text-sm rounded-[8px]"><span class="fa fa-plus ml-1"></span>افزودن برچسب جدید</a>
        </div>
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <div id="dropdown{{$index}}" class="z-10 hidden absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                                        <li>
                                            <a href="{{route('dashboard.tags.edit', $tag)}}" class="flex items-center justify-start gap-1 px-4 py-2 hover:bg-gray-100 text-lime-700"><span class="fa fa-edit ml-1"></span>ویرایش</a>
                                        </li>
                                        <li>
        ...
        {{$tags->links('dashboard.include.pagination')}}
    </div>
@endsection
